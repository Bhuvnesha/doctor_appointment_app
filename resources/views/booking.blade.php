...
<div class="page-active">
  <div class="container py-5">
    <div class="page-header mb-1 text-center">
      ...
      <p class="text-muted" style="font-size:0.9rem;">Fill in the form below and we'll confirm your slot within minutes.</p>
    </div>
    <div class="form-wrap mt-4">
      <div class="success-banner" id="successBanner">
        <i class="bi bi-check-circle-fill text-success" style="font-size:1.4rem;"></i>
        <div><strong>Appointment booked!</strong><br><span style="font-size:0.85rem;color:var(--muted);">You'll receive a confirmation shortly.</span></div>
      </div>
      <div class="form-card">
        <div class="mb-4">
          <div class="d-flex align-items-center mb-1"><span class="step-badge">1</span><span class="form-section-title">Personal Information</span></div>
          <hr style="border-color:var(--border);margin-bottom:20px;">
          <div class="row g-3">
            <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" id="f-name" placeholder="Anjali Verma"/></div>
            <div class="col-md-6"><label class="form-label">Email Address</label><input type="email" class="form-control" id="f-email" placeholder="anjali@example.com"/></div>
            <div class="col-md-6"><label class="form-label">Phone Number</label><input type="tel" class="form-control" id="f-phone" placeholder="+91 98765 43210"/></div>
            <div class="col-md-6"><label class="form-label">Date of Birth</label><input type="date" class="form-control" id="f-dob"/></div>
            <div class="col-md-6"><label class="form-label">Gender</label><select class="form-select" id="f-gender"><option value="">Select gender</option><option>Male</option><option>Female</option><option>Other</option></select></div>
            <div class="col-md-6"><label class="form-label">Blood Group</label><select class="form-select" id="f-blood"><option value="">Select</option><option>A+</option><option>A-</option><option>B+</option><option>B-</option><option>O+</option><option>O-</option><option>AB+</option><option>AB-</option></select></div>
          </div>
        </div>
        <div class="mb-4">
          <div class="d-flex align-items-center mb-1"><span class="step-badge">2</span><span class="form-section-title">Appointment Details</span></div>
          <hr style="border-color:var(--border);margin-bottom:20px;">
          <div class="row g-3">
            <div class="col-md-6"><label class="form-label">Department / Specialty</label><select class="form-select" id="f-dept"><option value="">Select specialty</option><option>Cardiology</option><option>Neurology</option><option>Dermatology</option><option>Orthopedics</option><option>General Medicine</option><option>Pediatrics</option></select></div>
            <div class="col-md-6"><label class="form-label">Preferred Doctor</label><select class="form-select" id="f-doc"><option value="">Select doctor</option><option>Dr. Priya Sharma</option><option>Dr. Arun Mehta</option><option>Dr. Sara Khan</option><option>Dr. Raj Verma</option></select></div>
            <div class="col-md-6"><label class="form-label">Appointment Date</label><input type="date" class="form-control" id="f-date"/></div>
            <div class="col-md-6"><label class="form-label">Preferred Time Slot</label><select class="form-select" id="f-time"><option value="">Select time</option><option>09:00 AM</option><option>10:00 AM</option><option>11:00 AM</option><option>12:00 PM</option><option>02:00 PM</option><option>03:00 PM</option><option>04:00 PM</option><option>05:00 PM</option></select></div>
            <div class="col-md-6"><label class="form-label">Appointment Type</label><select class="form-select" id="f-type"><option>In-Person</option><option>Tele-Consultation</option></select></div>
            <div class="col-md-6"><label class="form-label">Insurance Provider</label><input type="text" class="form-control" id="f-insurance" placeholder="e.g. Star Health (optional)"/></div>
            <div class="col-12"><label class="form-label">Symptoms / Reason for Visit</label><textarea class="form-control" id="f-symptoms" rows="3" placeholder="Briefly describe your symptoms..."></textarea></div>
          </div>
        </div>
        <button class="btn-book" onclick="bookAppointment()"><i class="bi bi-calendar-check me-2"></i>Confirm Appointment</button>
      </div>
    </div>
  </div>
</div>
